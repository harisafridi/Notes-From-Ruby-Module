...
ruby bining to nvigate a page and conduct basic ui automation
explore the funcutonality of selenium-webdriver from within IRB
...
- IE
- Safari 
- PhantomJS: contiuous integration headless driver
...
a= browser.find_element css: "class a-size-base a-color-price s-price a-text-bold"
...
a = browser.find_element id ,css , tag_nmae 
